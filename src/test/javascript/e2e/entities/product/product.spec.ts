...
describe('Product e2e test', () => {
    ...
    it('should load Products', async () => {
        ...
        expect(await productComponentsPage.getTitle()).to.eq('engenhosSkolEstacaoApp.product.home.title');
    });
    ...
    it('should load create Product page', async () => {
        ...
        expect(await productUpdatePage.getPageTitle()).to.eq('engenhosSkolEstacaoApp.product.home.createOrEditLabel');
    ...
    it('should create and save Products', async () => {
        ...
        await promise.all([
            ...
            productUpdatePage.slotSelectLastOption(),
            productUpdatePage.priceTableItemSelectLastOption()
        ]);
    ...
    it('should delete last Product', async () => {
        ...
        expect(await productDeleteDialog.getDialogTitle()).to.eq('engenhosSkolEstacaoApp.product.delete.question');
