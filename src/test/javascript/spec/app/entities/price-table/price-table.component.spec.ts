...
import { PriceTableComponent } from 'app/entities/price-table/price-table.component';
...
describe('Component Tests', () => {
    describe('PriceTable Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PriceTableComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.priceTables[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
