...
import { PriceTableItemComponent } from 'app/entities/price-table-item/price-table-item.component';
...
describe('Component Tests', () => {
    describe('PriceTableItem Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PriceTableItemComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.priceTableItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
